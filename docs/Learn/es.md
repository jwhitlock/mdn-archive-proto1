...
<div class="zone-landing-header-preview-base"><!-- zone subnav -->
...
<div class="center"><!-- start the main content container -->
<div class="wiki-right-closed wiki-right-none wiki-left-present" id="wiki-column-container"><!-- content row with three strips -->
<div class="column-container column-container-reverse"><!-- center: main article content -->
<div class="column-main wiki-column text-content" id="wiki-content"><!-- just the article content -->
<article id="wikiArticle"><!--cgsramirez -->
<p>{{draft}}</p>
<!-- I've decided to keep the english content while on the earlier stages of translation. The first stage is basically translate to spanish, almost literally. On the second stage,I'll be looking for ways to better express the intent of the english author, (to the best of my knowledge), without changing too much of the, (almost), literal translation. The third stage I'll be fixing typos and correcting bad spelling and grammar. the fourth stage is the final revision, and if everything went ok, the english content gets removed. -->
