...
<div class="column-container zone-callout"><a href="https://www.mozilla.org/en-US/firefox/developer/" target="_" style="float: right; margin-bottom: 20px; padding: 10px; text-align: center; border-radius: 4px; display: inline-block; background-color: #81BC2E; white-space: nowrap; color: white; text-shadow: 0px 1px 0px rgba(0, 0, 0, 0.25); box-shadow: 0px 1px 0px 0px rgba(0, 0, 0, 0.2), 0px -1px 0px 0px rgba(0, 0, 0, 0.3) inset;">Install Firefox Developer Edition</a>

<h3 name="What's_new_in_Aurora.3F" id="What's_new_in_Aurora.3F">What's new in Firefox Developer Edition?</h3>
...
<div class="column-container zone-callout"><a href="http://mzl.la/devtools" target="_" style="float: right; margin-bottom: 20px; padding: 10px; text-align: center; border-radius: 4px; display: inline-block; background-color: #81BC2E; white-space: nowrap; color: white; text-shadow: 0px 1px 0px rgba(0, 0, 0, 0.25); box-shadow: 0px 1px 0px 0px rgba(0, 0, 0, 0.2), 0px -1px 0px 0px rgba(0, 0, 0, 0.3) inset;">Share your ideas</a>

<h3 name="Share_your_ideas" id="Share_your_ideas">Share your ideas</h3>

<p>Ask for new features in the developer tools or vote for ideas other developers are asking for.</p>
</div>

<p><img src="https://mdn.mozillademos.org/files/10529/inspector.png" style="display:block; height:467px; margin-left:auto; margin-right:auto; width:815px" alt=""></p>
...
<div class="column-container">
<div class="column-half">
<h2 name="Debugging_the_browser" id="Debugging_the_browser">Debugging the browser</h2>
...
<div class="column-half">
<h2 name="Extending_the_devtools" id="Extending_the_devtools">Extending the devtools</h2>
...
<hr>
<h2 name="More_resources" id="More_resources">More resources</h2>
...
<h2 name="Subnav" id="Subnav">Subnav</h2>
