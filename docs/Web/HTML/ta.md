...
based_on: 48ac896058b00feb4ac0129743867ef687b5dd23
---
<div>{{HTMLSidebar}}</div>

<div><span class="seoSummary"><strong>மீசுட்டு மொழி</strong> (மீயுரைக் குறியிடு மொழி) இனையதள கட்டுமானத்தின் அடிப்படை கட்டுமான மொழி. இது ஒரு வலைப்பக்கத்தை வரையறுக்கவும் விவரிக்கவும் பயன்படுகிறது. HTMLஐ தவிர வேறு <span class="short_text" id="result_box" lang="ta">தொழில்நுட்பங்கள் யாவும்</span><span class="seoSummary">வலைபக்கத்தின் தோற்றத்தையோ (<a href="/en-US/docs/Web/CSS">CSS</a>) அல்லது செயல்பாட்டையோ (<a href="/en-US/docs/Web/JavaScript">JavaScript</a>) விவரிக்க பயன்படுகிறது</span>.</span></div>
