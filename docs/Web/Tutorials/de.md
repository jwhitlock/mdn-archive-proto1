  ...
  <tr>
   ...
   <td>
    ...
    <dl>
     ...
     <dt>
      <a href="https://developer.mozilla.org/en-US/docs/JavaScript/Getting_Started">Mit JavaScript loslegen</a></dt>
     <dd>
      Was ist JavaScript und wie kann es Ihnen helfen?</dd>
     <dt>
      <a href="http://docs.webplatform.org/wiki/concepts/programming/programming_basics" rel="external">Programmieren - Die Grundlagen</a> (WebPlatform.org)</dt>
     <dd>
