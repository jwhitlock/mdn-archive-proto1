...
<h3 id="Равно_()"><a name="Equality">Равно (==)</a></h3>
...
<h3 id="Идентичность_строгое_равенство_()"><a name="Identity">Строго&nbsp;равно&nbsp;(===)</a></h3>
...
<h3 id="Неидентичность_строгое_неравенство_(!)"><a name="Nonidentity">Строго&nbsp;не равно (!==)</a></h3>
...
<h2 id="Относительные_(реляционные)_операторы">Операторы сравнения</h2>
