...
<div class="initial-steps clear" id="sect1">
 <div class="panel">
  <h2 class="section-design" id="Design"><a href="/en-US/docs/Web/Apps/Design">설계하기</a></h2>
  ...
  <ul class="no-bullets">
   ...
   <li><a href="/en-US/Apps/app_layout/responsive_design_building_blocks">반응형 디자인</a></li>
  </ul>
 </div>
 <div class="panel">
  <h2 class="section-build" id="Build"><a href="/en-US/docs/Web/Apps/Build">개발하기</a></h2>
