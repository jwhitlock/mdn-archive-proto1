...
<div class="cleared topicpage-table">
 <div class="section">
  ...
  <p><span class="alllinks"><a href="/en-US/docs/tag/Accessibility" title="/en-US/docs/tag/Accessibility">ყველა სტატია ხემისაწვდომობის შესახებ...</a></span></p>
 </div>
 <div class="section">
  <h2 class="Tools" id="Tools" name="Tools">ინსტრუმენტები ვებ დეველოპერებისათვის</h2>
  <ul>
  ...
  <p><span class="alllinks"><a href="/en-US/docs/tag/Accessibility:Tools" title="en-US/docs/tag/Accessibility:Tools">იხილე ყველა...</a></span></p>
  <h2 class="Tools" id="Tools" name="Tools">სხვა სასარგებლო საიტები</h2>
  <ul>
